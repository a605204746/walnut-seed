...
import com.walnut.seed.common.satoken.config.properties.SecurityProperties;
import com.walnut.seed.common.satoken.handler.AllUrlHandler;
...
public class SecurityConfig implements WebMvcConfigurer {
    ...
    /**
     * 注册 AllUrlHandler，收集所有 URL 用于权限拦截
     */
    @Bean
