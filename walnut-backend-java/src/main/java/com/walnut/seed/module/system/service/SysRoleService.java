...
public interface SysRoleService {
     ...
     * @return 角色分页列表
     */
    PageResult<SysRoleResp> selectPageRoleList(SysRoleReq req);
     ...
     * @return 角色数据集合信息
     */
    List<SysRoleResp> selectRoleList(SysRoleReq req);
     ...
     * @return 角色列表
     */
    List<SysRoleResp> selectRolesByUserId(Long userId);
     ...
     * @return 角色列表
     */
    List<SysRoleResp> selectRolesAuthByUserId(Long userId);
     ...
     * @return 角色列表
     */
    List<SysRoleResp> selectRoleAll();
     ...
     * @return 角色对象信息
     */
    SysRoleResp selectRoleById(Long roleId);
     ...
     * @return 角色列表信息
     */
    List<SysRoleResp> selectRoleByIds(List<Long> roleIds);
     ...
     * @return 结果
     */
    boolean checkRoleNameUnique(SysRoleReq req);
     ...
     * @return 结果
     */
    boolean checkRoleKeyUnique(SysRoleReq req);
     ...
     * @param role 角色信息
     */
    void checkRoleAllowed(SysRoleReq req);
     ...
     * @return 结果
     */
    int authDataScope(SysRoleReq req);
