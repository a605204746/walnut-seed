...
export function roleList(params?: PageQuery) {
  return request.get<PageResult<Role>>(Api.roleList, { params });
}
...
export function roleInfo(roleId: ID) {
  return request.get<Role>(`${Api.root}/${roleId}`);
}
...
export function roleChangeStatus(data: Partial<Role>) {
  ...
  return request.putWithMsg<void>(Api.roleChangeStatus, requestData);
}
...
export function roleRemove(roleIds: IDS) {
  return request.deleteWithMsg<void>(`${Api.root}/${roleIds}`);
}
...
export function roleDataScope(data: any) {
  return request.putWithMsg<void>(Api.roleDataScope, data);
}
...
export function roleOptionSelect(params?: any) {
  return request.get(Api.roleOptionSelect, { params });
}
...
export function roleAllocatedList(params?: PageQuery) {
  return request.get<PageResult<User>>(Api.roleAllocatedList, { params });
}
...
export function roleUnallocatedList(params: any) {
  return request.get<PageResult<User>>(Api.roleUnallocatedList, {
    params,
  });
}
...
export function roleAuthCancel(data: { roleId: ID; userId: ID }) {
  return request.putWithMsg<void>(Api.roleAuthCancel, data);
}
...
export function roleAuthCancelAll(roleId: ID, userIds: IDS) {
  return request.putWithMsg<void>(
...
export function roleDeptTree(roleId: ID) {
  return request.get<DeptResp>(`${Api.roleDeptTree}/${roleId}`);
}
